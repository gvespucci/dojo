...
public class LWUITCommandByEqualsMIDlet extends MIDlet implements ActionListener {
	...
	public LWUITCommandByEqualsMIDlet() {
		Display.init(this);
	}
	
	protected void startApp() throws MIDletStateChangeException {
		Form form = new Form("Command-By-Equals-MIDlet - LWUIT Version");
